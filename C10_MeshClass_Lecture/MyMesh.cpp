...
void MyMesh::GenerateCube(float size)
{
	...
	lPos.push_back(vector3(0, 0, 0));
	lPos.push_back(vector3(size, 0, 0));
	lPos.push_back(vector3(size, size, 0));
	lPos.push_back(vector3(0, size, 0));

	lPos.push_back(vector3(0, 0, size));
	lPos.push_back(vector3(size, 0, size));
	lPos.push_back(vector3(size, size, size));
	lPos.push_back(vector3(0, size, size));
	...
	AddVertexPosition(lPos[4]);
	AddVertexPosition(lPos[6]);
	AddVertexPosition(lPos[7]);

	// LEFT
	AddVertexPosition(lPos[4]);
	AddVertexPosition(lPos[0]);
	AddVertexPosition(lPos[3]);
	...
	AddVertexPosition(lPos[5]);
	AddVertexPosition(lPos[1]);
	AddVertexPosition(lPos[2]);
